...
$sql="select a.descripcion as label,COUNT(*) as value from mantenimiento m INNER JOIN aceptacion a on m.id_acept=a.id_acept where anio='".$idanio."' and numperiod='".$idperiod."' GROUP BY label ";
