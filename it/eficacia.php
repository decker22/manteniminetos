                    ...
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                ...
                                <?php
                          if($_SESSION['empresa_admin']=='ksmx')
                          echo "<center><b class='text-success'>  NIVEL DE EFICACIA DE KOLBENSCHMIDT KSPG</b></center>";
                              if($_SESSION['empresa_admin']=='ksgl')
                                  echo "<center><b class='text-info'>  NIVEL DE EFICACIA DE GLEITLAGER KSPG</b></center>";
                                      if($_SESSION['empresa_admin']=='ppt')
                                          echo "<center><b class='text-danger'>  NIVEL DE EFICACIA DE PIERBURG KSPG</b></center>";
                                        ...
                                        <div id="morris-donut-chart">
                                            ...
                                            <script>
                                                ...
                                                function p_grafica() {
                                                    ...
                                                    xmlhttp.open("GET", "consulta_eficiencia.php?valor=" + valor + "&valor2="+valor2, true);
                                                    xmlhttp.send();
